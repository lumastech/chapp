...
public class CenterUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = CenterUpdateActivity.this;
    ...
    public void postCenter(Center request){
        ...
        if (cm.getActiveNetworkInfo() != null && cm.getActiveNetworkInfo().isConnected()){
            Call<ApiResponse> registerResponseCall = Api.apiCall().centerUpdate(request, utility.readFile("token"));
    ...
    public void updateView(){
        ...
        latEdit.setText(i.getStringExtra("lat"));
        lnglEdit.setText(i.getStringExtra("lng"));
        descriptionEdit.setText(i.getStringExtra("description"));
    }
}